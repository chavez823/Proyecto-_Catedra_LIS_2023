...
CREATE TABLE Cliente (
	...
	Fecha_Verificacion_Email DATETIME NOT NULL,
    PRIMARY KEY (DUI)
)ENGINE=InnoDB;
...
INSERT INTO estado_oferta (ID_EstadoOferta, Nombre) VALUES ('1', 'Espera de aprobación'), ('2', 'Aprobadas futuras '),
 ('3', 'Activas'), ('4', ' Pasadas'),
 ('5', 'Rechazadas'), ('6', 'Descartadas');
INSERT INTO rubro (ID_Rubro, Nombre) 
VALUES ('1', 'Salón de belleza'), ('2', 'Restaurante '),
('3', 'Taller'), ('4', 'Estructuras metálicas'),
...
VALUES 
('EMP001', 'Pollo de Oro', 'Blvr. del ejército, Centro comercial Plaza Mundo, 2° nivel, Soyapango ', 'Mario Rivas', '77223344', 'armando.lopez@lis.com', '0.1', '2'), ('EMP002', 'El Super De Todos', 'PR2X+6P5, Blvr. del Ejercito Nacional, Soyapango', 'Luis Garcia', '77669955', 'super.todos@lis.com', '0.05', '5'),
 ('EMP003', 'Farmacia Amigo', 'Frente a, Entre 5a y 7a Avenida Norte y, 15 Calle Pte., San Salvador', 'Arturo Ramírez ', '66789045', 'farma.amigo@gmail.com', '0.15', '6'), ('EMP004', 'Destellos Vicky Salón ', 'P.º Gral. Escalón 3656, San Salvador', 'Victoria Flores', '77452987', 'destellos.vicky@lis.com', '0.08', '1');
...
('6', 'Manicura al 2x1', '100', 'por la primera manicura te llevas la segunda gratis ', 'No importa el largo de la uña', '2023-05-01', '2023-08-01','24','12','https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4842/9781484217290.jpg','EMP004','3', '', '2023-08-01'),
...
('11', 'Jueves dia de Pigmentación con hena ', '100', 'Pigmenta tus cejas amitad de precio', 'Cualquier tono de hena', '2023-05-01', '2023-08-01','6','4.50','https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4842/9781484217290.jpg','EMP004','4', '', '2023-08-01'),
('12', 'Jamón al 2x1', '100', 'por la compra de un jamón te llevas el segundo gratis', 'valido todos los fines de semana', '2023-05-01', '2023-05-01','6','4.50','https://d1w7fb2mkkr3kw.cloudfront.net/assets/images/book/lrg/9781/4842/9781484217290.jpg','EMP001','6', 'No cumple los reglametos de la cuponeria', '2023-05-01'),
...
VALUES 
 ('0' , 'Armando' , 'López', '234567', 'armando.lopez@lis.com', 'Administrador'),
 ('1', 'Romero ', 'Hernandez', '123456', 'romero.hernandez@lis.com', 'Cliente');
INSERT INTO empleado(ID_Empleado, ID_Empresa, ID_Usuario, Tipo)
VALUES ('1', 'EMP001', '1',  'Administrador');
Insert Into cliente (DUI, Nombres,Apellidos,Contrasenia,Correo,Telefono , Direccion , Token,Fecha_Verificacion_Email) 
VALUES  ('00167564', 'Richard Mario','Molina Aguilar','sddfsfdsdsfg','semita@horchata.com','75080845', 'Ciudad delgado, canton plan del pino colonia mercedes casa 30A ', 'cliente1','2023-03-17 11:53:02');
